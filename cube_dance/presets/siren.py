...
from ..visuals.engine.elements import HeldGlow, HeldStrobe, KickPulse, Shockwave, SirenStrobe
...
TRIGGERS = [
    Trigger("red", (255, 30, 30), lambda m, s, c: HeldGlow(m, c, release=0.25), hold=True),
    Trigger("blue", (40, 80, 255), lambda m, s, c: HeldGlow(m, c, release=0.25), hold=True),
    Trigger("strobe", (255, 255, 255), lambda m, s, c: HeldStrobe(m, c, interval=0.05), hold=True),
    Trigger("shock", (255, 200, 0), lambda m, s, c: Shockwave(m, c, dur=0.5, gain=1.5 * s)),  # fire
]
