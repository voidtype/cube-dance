"""`lacingwave` - a wave sweeping across the corner truss triangles."""
...
TRIGGERS = [
    Trigger("flash", (255, 200, 120), lambda m, s, c: el.ColorStab(m,c,gain=s,release=0.5,region='corners')),
...
def build(engine) -> None:
    engine.add(fx.LacingWave(engine.model))
